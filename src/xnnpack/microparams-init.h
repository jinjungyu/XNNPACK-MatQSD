...
#define DECLARE_INIT_QS8_QC8W_CONV_MINMAX_PARAMS_FUNCTION(fn_name)           \
  XNN_INTERNAL size_t fn_name(union xnn_qs8_qc8w_conv_minmax_params* params, \
                              int8_t output_zero_point, int8_t output_min,   \
                              int8_t output_max);

DECLARE_INIT_QS8_QC8W_CONV_MINMAX_PARAMS_FUNCTION(
...
#define DECLARE_INIT_QS8_CONV_MINMAX_PARAMS_FUNCTION(fn_name)           \
  XNN_INTERNAL size_t fn_name(union xnn_qs8_conv_minmax_params* params, \
                              float scale, int8_t output_zero_point,    \
...
#define DECLARE_INIT_QU8_CONV_MINMAX_PARAMS_FUNCTION(fn_name)                \
  XNN_INTERNAL size_t fn_name(union xnn_qu8_conv_minmax_params* params,      \
                              uint8_t kernel_zero_point, float scale,        \
                              uint8_t output_zero_point, uint8_t output_min, \
                              uint8_t output_max);
...
XNN_INTERNAL void xnn_init_qs8_qc8w_scale_fp32_params(size_t channels,
...
XNN_INTERNAL void xnn_init_qs8_to_qs8_qc8w_scale_fp32_params(
    size_t channels, size_t channels_tile, size_t stride, const float* scale,
    void* packed_w);
...
XNN_INTERNAL void xnn_init_blockwise_scale_fp32_params(
    ...
    size_t block_stride, const float* scale, void* packed_w);

XNN_INTERNAL void xnn_init_blockwise_scale_bf16_params(
    size_t channels, size_t channels_tile, size_t stride, size_t num_blocks,
    size_t block_stride, const xnn_bfloat16* scale, void* packed_w);
...
#define DECLARE_UPDATE_REDUCE_PARAMS_FUNCTION(fn_name) \
  XNN_INTERNAL size_t fn_name(struct xnn_reduce_params* params, float scale);
...
XNN_INTERNAL size_t xnn_init_s8_minmax_scalar_params(
    struct xnn_s8_minmax_params* params, int8_t output_min, int8_t output_max);

XNN_INTERNAL size_t
xnn_init_u8_minmax_scalar_params(struct xnn_u8_minmax_params* params,
                                 uint8_t output_min, uint8_t output_max);

XNN_INTERNAL size_t xnn_init_bf16_minmax_scalar_params(
    struct xnn_bf16_minmax_params* params, xnn_bfloat16 output_min,
    xnn_bfloat16 output_max);

XNN_INTERNAL size_t xnn_init_f16_minmax_scalar_params(
    struct xnn_f16_minmax_params* params, xnn_float16 output_min,
    xnn_float16 output_max);

XNN_INTERNAL size_t xnn_init_f32_minmax_scalar_params(
    struct xnn_f32_minmax_params* params, float output_min, float output_max);

XNN_INTERNAL size_t xnn_init_f16_qc4w_minmax_scalar_params(
    struct xnn_f16_qc4w_minmax_params* params, xnn_float16 output_min,
    xnn_float16 output_max, uint8_t kernel_zero_point);

XNN_INTERNAL size_t xnn_init_f16_qb4w_minmax_scalar_params(
    struct xnn_f16_qb4w_minmax_params* params, xnn_float16 output_min,
    xnn_float16 output_max, uint8_t kernel_zero_point, size_t blocksize);

XNN_INTERNAL size_t xnn_init_f32_qc4w_minmax_scalar_params(
    struct xnn_f32_qc4w_minmax_params* params, float output_min,
    float output_max, uint8_t kernel_zero_point);
...
XNN_INTERNAL size_t xnn_init_f32_mqint8_minmax_scalar_params(
    struct xnn_f32_mqint8_minmax_params* params, float output_min,
    float output_max, uint8_t kernel_zero_point, size_t blocksize);
...
XNN_INTERNAL size_t xnn_init_qs8_add_minmax_scalar_params(
    struct xnn_qs8_add_minmax_params* uparams,
...
XNN_INTERNAL size_t xnn_init_qu8_add_minmax_scalar_params(
    struct xnn_qu8_add_minmax_params* uparams,
    const struct xnn_quantization_params* a_quantization,
    const struct xnn_quantization_params* b_quantization,
    const struct xnn_quantization_params* output_quantization);
...
#define DECLARE_INIT_QS8_MUL_MINMAX_PARAMS_FUNCTION(fn_name) \
  XNN_INTERNAL size_t fn_name(                               \
      union xnn_qs8_mul_minmax_params* uparams,              \
      const struct xnn_quantization_params* a_quantization,  \
      const struct xnn_quantization_params* b_quantization,  \
      const struct xnn_quantization_params* output_quantization);
...
#define DECLARE_INIT_QU8_MUL_MINMAX_PARAMS_FUNCTION(fn_name) \
  XNN_INTERNAL size_t fn_name(                               \
      union xnn_qu8_mul_minmax_params* uparams,              \
      const struct xnn_quantization_params* a_quantization,  \
      const struct xnn_quantization_params* b_quantization,  \
      const struct xnn_quantization_params* output_quantization);
...
#define DECLARE_INIT_QS8_VPRELU_PARAMS_FUNCTION(fn_name)    \
  XNN_INTERNAL size_t fn_name(                              \
      union xnn_qs8_vprelu_scalar_params* uparams,          \
      const struct xnn_quantization_params* a_quantization, \
      const struct xnn_quantization_params* b_quantization, \
      const struct xnn_quantization_params* output_quantization);
